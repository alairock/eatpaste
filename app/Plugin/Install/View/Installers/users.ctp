	...
	<div class="span8 grayLighter body-container">
		...
		<div class="span4">
			...
			<p>
				...
				<?php echo $this->Form->input('username', array('label' => false, 'placeholder' => 'Admin Username')); ?>
				<?php echo $this->Form->input('password', array('label' => false, 'placeholder' => 'Admin Password')); ?>
				<?php echo $this->Form->input('email', array('label' => false, 'placeholder' => 'you@yourdomain.com')); ?>
